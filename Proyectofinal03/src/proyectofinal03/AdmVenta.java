...
public class AdmVenta {
    ...
    public void registrarVentas( String concepto, String numero, String fEmision, String fVencimiento, String fPago, String estado, String moneda, double subTotal, double igv, double total, String observaciones, String tipo) 
            throws BusinessException {
        validarDatos(concepto, fEmision,fVencimiento,subTotal,igv,total,moneda);        
        // Crear un nuevo producto
      Venta ven = new Venta(concepto,numero,fEmision,fVencimiento,fPago,estado,moneda,subTotal,igv,total,observaciones,tipo);
       ...
       for (Venta oVenta : lstVenta)  
        {
             if(concepto.equals(oVenta.getConcepto()) || numero.equals(oVenta.getNumero())
                      || fvencimiento.equals(oVenta.getfVencimiento())
